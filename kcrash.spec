...
Source0  : https://download.kde.org/stable/frameworks/6.14/kcrash-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kcrash-6.14.0.tar.xz.sig
...
%setup -q -n kcrash-6.14.0
cd %{_builddir}/kcrash-6.14.0
pushd ..
cp -a kcrash-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747069136
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Crash.so.6.14.0
