...
Version  : 6.7.0
Release  : 92
URL      : https://download.kde.org/stable/frameworks/6.7/kcrash-6.7.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.7/kcrash-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/kcrash-6.7.0.tar.xz.sig
...
%setup -q -n kcrash-6.7.0
cd %{_builddir}/kcrash-6.7.0
pushd ..
cp -a kcrash-6.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728684414
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Crash.so.6.7.0
/usr/lib64/libKF6Crash.so.6
/usr/lib64/libKF6Crash.so.6.7.0
