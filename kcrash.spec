...
Source0  : https://download.kde.org/stable/frameworks/5.111/kcrash-5.111.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.111/kcrash-5.111.0.tar.xz.sig
...
%prep
%setup -q -n kcrash-5.111.0
cd %{_builddir}/kcrash-5.111.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698093142
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Crash.so.5.111.0
/usr/lib64/libKF5Crash.so.5
/usr/lib64/libKF5Crash.so.5.111.0
