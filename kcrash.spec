...
Source0  : https://download.kde.org/stable/frameworks/5.99/kcrash-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kcrash-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kcrash-5.99.0
cd %{_builddir}/kcrash-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665419051
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Crash.so.5.99.0
