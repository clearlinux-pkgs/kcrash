...
Version  : 6.1.0
Release  : 83
URL      : https://download.kde.org/stable/frameworks/6.1/kcrash-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kcrash-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kcrash-6.1.0.tar.xz.sig
...
%setup -q -n kcrash-6.1.0
cd %{_builddir}/kcrash-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712947094
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Crash.so.6.1.0
/usr/lib64/libKF6Crash.so.6
/usr/lib64/libKF6Crash.so.6.1.0
