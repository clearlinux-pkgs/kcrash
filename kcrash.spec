...
Source0  : https://download.kde.org/stable/frameworks/5.78/kcrash-5.78.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.78/kcrash-5.78.0.tar.xz.sig
...
%prep
%setup -q -n kcrash-5.78.0
cd %{_builddir}/kcrash-5.78.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611176226
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcrash-5.78.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcrash/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Crash.so.5.78.0
