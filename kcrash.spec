...
Source0  : https://download.kde.org/stable/frameworks/5.85/kcrash-5.85.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.85/kcrash-5.85.0.tar.xz.sig
...
%prep
%setup -q -n kcrash-5.85.0
cd %{_builddir}/kcrash-5.85.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630897352
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcrash-5.85.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kcrash/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kcrash-5.85.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcrash/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kcrash-5.85.0/autotests/core_patterns/exec-apport.license %{buildroot}/usr/share/package-licenses/kcrash/864bc0eb28c73bd997ac19ff91935ab771846615
cp %{_builddir}/kcrash-5.85.0/autotests/core_patterns/exec.license %{buildroot}/usr/share/package-licenses/kcrash/864bc0eb28c73bd997ac19ff91935ab771846615
cp %{_builddir}/kcrash-5.85.0/autotests/core_patterns/no-exec.license %{buildroot}/usr/share/package-licenses/kcrash/864bc0eb28c73bd997ac19ff91935ab771846615
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Crash.so.5.85.0
